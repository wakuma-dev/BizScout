...
    e.preventDefault();
    if (isSignUpMode) {
      const success = await signup({ name, email: emailAddress, password });
...
            <button
              type="button"
              onClick={() => alert("Google Single Sign-On simulation pipeline executing.")}
...
              </svg>
              <span className="text-xs text-slate-700">Log in using Google</span>
            </button>
